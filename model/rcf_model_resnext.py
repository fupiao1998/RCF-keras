...
def resnext_rcf(input_shape=None):
    # Input
    ...
    x1_conv2 = residual_block(x1_conv1, 12, stride=(1, 1))
    ...
    x2_conv2 = residual_block(x2_conv1, 12, stride=(1, 1))
    ...
    x3_conv2 = residual_block(x3_conv1, 12, stride=(1, 1))
    x3_conv2_out = Conv2D(21, (1, 1), activation='relu', padding='same', name='block3_conv_o2')(x3_conv2)
    x3_conv3 = residual_block(x3_conv2, 12, stride=(1, 1))
    ...
    x4_conv2 = residual_block(x4_conv1, 12, stride=(1, 1))
    x4_conv2_out = Conv2D(21, (1, 1), activation='relu', padding='same', name='block4_conv_o2')(x4_conv2)
    x4_conv3 = residual_block(x4_conv2, 12, stride=(1, 1))
    ...
    x5_conv2 = residual_block(x5_conv1, 12, stride=(1, 1))
    x5_conv2_out = Conv2D(21, (1, 1), activation='relu', padding='same', name='block5_conv_o2')(x5_conv2)
    x5_conv3 = residual_block(x5_conv2, 12, stride=(1, 1))
