...
def args_parse():
    ...
    return args
'''
-dtrain D:\\all-PythonCodes\\RCFs\\RCF-keras\\dataset\\image
-dlabel D:\\all-PythonCodes\\RCFs\\RCF-keras\\dataset\\label
-dtest D:\\all-PythonCodes\\python_for_fun\\Keras_U-net\\data\\train_traffic\\test
-npath D:\\all-PythonCodes\\RCFs\\RCF-keras\\dataset
-itype jpg
-r 320
-c 480
'''
